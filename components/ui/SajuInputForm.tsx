    ...
    <div className="w-full max-w-md mx-auto">
      ...
      >
            ...
            <div className="grid grid-cols-2 gap-3">
              {(['male', 'female'] as const).map((g) => (
                <button
                  ...
                  className="saju-gender-option py-4 rounded-2xl border font-bold transition-all"
                >
                  {g === 'male' ? '남성' : '여성'}
                </button>
              ))}
        ...
        >
          ...
          <div className="relative w-full bg-[linear-gradient(135deg,#1F2A44_0%,#263554_54%,#A77C2F_100%)] text-[#fff] font-black py-5 rounded-2xl shadow-xl shadow-[#1F2A44]/20 flex items-center justify-center gap-3 transition-all active:scale-[0.97]">
            {status === 'loading' ? (
